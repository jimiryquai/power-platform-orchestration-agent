...
// Proper MCP Server following official documentation (CommonJS version)
  ...
  try {
    switch (name) {
      ...
      case 'get_project_status':
        const { operationId: statusOperationId } = args;
          ...
          content: [
            {
              ...
              text: JSON.stringify({
                ...
                message: `Operation ${statusOperationId} is ${randomStatus}`
              }, null, 2)
            }
          ]
        };
